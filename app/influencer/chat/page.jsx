...
export default function Chat({ params }) {
  ...
  const handleConversationClick = async (conversation) => {
    ...
    const otherUserInfo = conversation.userIds.find(
  ...
  useEffect(() => {
    const initChat = async () => {
      try {
        ...
        const info =
          decodedToken?.role === "influencer"
            ? data.companyProfile.company
            : data.influencerProfile.influencer;
                      ...
                      <div className="flex items-center gap-3">
                        <div className="relative">
                          <Avatar className="w-10 h-10">
                            <AvatarImage
                              src={otherUser?.pfp || "/placeholder.svg"}
                            />
                  ...
                  <div className="h-[600px] flex flex-col">
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4">
                      {messages.map((message, index) => {
                        const isCurrentUser =
                          message.postedByUser._id === currentUser.id;
                        return (
                          <div
                            key={index}
                            className={`flex ${
                          ...
                          >
                            ...
                            >
                              <Avatar className="w-8 h-8 flex-shrink-0">
                                <AvatarImage
                                  src={
                                    message.postedByUser.pfp ||
                                    "/placeholder.svg"
                                  }
                                />
                                <AvatarFallback className="bg-[#d9d9d9] text-[#71839b] text-xs">
                                  {message.postedByUser.username?.charAt(0) ||
                                    "U"}
                                </AvatarFallback>
                              </Avatar>
                              <div
                              ...
                              >
                                ...
                                >
                                  {message.type === "image" ? (
                                    <img
                                      src={
                                        message.message || "/placeholder.svg"
                                      }
                                      alt="Shared image"
